...
enum UpsampleParameter_UpsampleOp {
  UpsampleParameter_UpsampleOp_NEAREST = 0,
  UpsampleParameter_UpsampleOp_BILINEAR = 1
};
bool UpsampleParameter_UpsampleOp_IsValid(int value);
const UpsampleParameter_UpsampleOp UpsampleParameter_UpsampleOp_UpsampleOp_MIN = UpsampleParameter_UpsampleOp_NEAREST;
const UpsampleParameter_UpsampleOp UpsampleParameter_UpsampleOp_UpsampleOp_MAX = UpsampleParameter_UpsampleOp_BILINEAR;
const int UpsampleParameter_UpsampleOp_UpsampleOp_ARRAYSIZE = UpsampleParameter_UpsampleOp_UpsampleOp_MAX + 1;

const ::google::protobuf::EnumDescriptor* UpsampleParameter_UpsampleOp_descriptor();
inline const ::std::string& UpsampleParameter_UpsampleOp_Name(UpsampleParameter_UpsampleOp value) {
  return ::google::protobuf::internal::NameOfEnum(
    UpsampleParameter_UpsampleOp_descriptor(), value);
}
inline bool UpsampleParameter_UpsampleOp_Parse(
    const ::std::string& name, UpsampleParameter_UpsampleOp* value) {
  return ::google::protobuf::internal::ParseNamedEnum<UpsampleParameter_UpsampleOp>(
    UpsampleParameter_UpsampleOp_descriptor(), name, value);
}
enum Phase {
  TRAIN = 0,
  TEST = 1
...
class LayerParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.LayerParameter) */ {
 public:
  ...
  const ::caffe::ClipParameter& clip_param() const;
  ::caffe::ClipParameter* mutable_clip_param();
  ::caffe::ClipParameter* release_clip_param();
  void set_allocated_clip_param(::caffe::ClipParameter* clip_param);
  ...
  ::caffe::SwishParameter* release_swish_param();
  ...
  // optional .caffe.PermuteParameter permute_param = 150;
  bool has_permute_param() const;
  void clear_permute_param();
  static const int kPermuteParamFieldNumber = 150;
  ...
  static const int kUpsampleParamFieldNumber = 151;
  ...
  // optional .caffe.ReorgParameter reorg_param = 152;
  bool has_reorg_param() const;
  void clear_reorg_param();
  static const int kReorgParamFieldNumber = 152;
...
class ClipParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.ClipParameter) */ {
 public:
  ClipParameter();
  ...
  inline ClipParameter* New() const { return New(NULL); }

  ClipParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class PoolingParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.PoolingParameter) */ {
 public:
  ...
  static const RoundMode CEIL =
    PoolingParameter_RoundMode_CEIL;
  static const RoundMode FLOOR =
  ...
  ::caffe::PoolingParameter_RoundMode round_mode() const;
  void set_round_mode(::caffe::PoolingParameter_RoundMode value);
...
class SwishParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.SwishParameter) */ {
 public:
  SwishParameter();
  ...
  inline SwishParameter* New() const { return New(NULL); }

  SwishParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
class UpsampleParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.UpsampleParameter) */ {
 public:
  UpsampleParameter();
  ...
  inline UpsampleParameter* New() const { return New(NULL); }

  UpsampleParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  typedef UpsampleParameter_UpsampleOp UpsampleOp;
  static const UpsampleOp NEAREST =
    UpsampleParameter_UpsampleOp_NEAREST;
  static const UpsampleOp BILINEAR =
    UpsampleParameter_UpsampleOp_BILINEAR;
  static inline bool UpsampleOp_IsValid(int value) {
    return UpsampleParameter_UpsampleOp_IsValid(value);
  }
  static const UpsampleOp UpsampleOp_MIN =
    UpsampleParameter_UpsampleOp_UpsampleOp_MIN;
  static const UpsampleOp UpsampleOp_MAX =
    UpsampleParameter_UpsampleOp_UpsampleOp_MAX;
  static const int UpsampleOp_ARRAYSIZE =
    UpsampleParameter_UpsampleOp_UpsampleOp_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  UpsampleOp_descriptor() {
    return UpsampleParameter_UpsampleOp_descriptor();
  }
  static inline const ::std::string& UpsampleOp_Name(UpsampleOp value) {
    return UpsampleParameter_UpsampleOp_Name(value);
  }
  static inline bool UpsampleOp_Parse(const ::std::string& name,
      UpsampleOp* value) {
    return UpsampleParameter_UpsampleOp_Parse(name, value);
  }
  ...
  ::google::protobuf::int32 height_scale() const;
  void set_height_scale(::google::protobuf::int32 value);
  ...
  ::google::protobuf::int32 width_scale() const;
  void set_width_scale(::google::protobuf::int32 value);

  // optional .caffe.UpsampleParameter.UpsampleOp mode = 5 [default = BILINEAR];
  bool has_mode() const;
  void clear_mode();
  static const int kModeFieldNumber = 5;
  ::caffe::UpsampleParameter_UpsampleOp mode() const;
  void set_mode(::caffe::UpsampleParameter_UpsampleOp value);
 ...
 private:
  ...
  ::google::protobuf::int32 height_;
  ::google::protobuf::int32 width_;
  ::google::protobuf::int32 height_scale_;
  ::google::protobuf::int32 width_scale_;
  int mode_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
inline ::caffe::ClipParameter* LayerParameter::mutable_clip_param() {
  set_has_clip_param();
  if (clip_param_ == NULL) {
    clip_param_ = new ::caffe::ClipParameter;
  }
...
inline ::caffe::ClipParameter* LayerParameter::release_clip_param() {
  // @@protoc_insertion_point(field_release:caffe.LayerParameter.clip_param)
  clear_has_clip_param();
...
inline ::caffe::SwishParameter* LayerParameter::mutable_swish_param() {
  set_has_swish_param();
  if (swish_param_ == NULL) {
    swish_param_ = new ::caffe::SwishParameter;
  }
...
// optional int32 height = 1 [default = 32];
inline bool UpsampleParameter::has_height() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void UpsampleParameter::set_has_height() {
  _has_bits_[0] |= 0x00000001u;
}
inline void UpsampleParameter::clear_has_height() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void UpsampleParameter::clear_height() {
  height_ = 32;
  clear_has_height();
}
inline ::google::protobuf::int32 UpsampleParameter::height() const {
  // @@protoc_insertion_point(field_get:caffe.UpsampleParameter.height)
  return height_;
}
inline void UpsampleParameter::set_height(::google::protobuf::int32 value) {
  set_has_height();
  height_ = value;
  // @@protoc_insertion_point(field_set:caffe.UpsampleParameter.height)
}

// optional int32 width = 2 [default = 32];
inline bool UpsampleParameter::has_width() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void UpsampleParameter::set_has_width() {
  _has_bits_[0] |= 0x00000002u;
}
inline void UpsampleParameter::clear_has_width() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void UpsampleParameter::clear_width() {
  width_ = 32;
  clear_has_width();
}
inline ::google::protobuf::int32 UpsampleParameter::width() const {
  // @@protoc_insertion_point(field_get:caffe.UpsampleParameter.width)
  return width_;
}
inline void UpsampleParameter::set_width(::google::protobuf::int32 value) {
  set_has_width();
  width_ = value;
  // @@protoc_insertion_point(field_set:caffe.UpsampleParameter.width)
}

// optional int32 height_scale = 3 [default = 2];
inline bool UpsampleParameter::has_height_scale() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void UpsampleParameter::set_has_height_scale() {
  _has_bits_[0] |= 0x00000004u;
}
inline void UpsampleParameter::clear_has_height_scale() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void UpsampleParameter::clear_height_scale() {
  height_scale_ = 2;
  clear_has_height_scale();
}
inline ::google::protobuf::int32 UpsampleParameter::height_scale() const {
  // @@protoc_insertion_point(field_get:caffe.UpsampleParameter.height_scale)
  return height_scale_;
}
inline void UpsampleParameter::set_height_scale(::google::protobuf::int32 value) {
  set_has_height_scale();
  height_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.UpsampleParameter.height_scale)
}

// optional int32 width_scale = 4 [default = 2];
inline bool UpsampleParameter::has_width_scale() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void UpsampleParameter::set_has_width_scale() {
  _has_bits_[0] |= 0x00000008u;
}
inline void UpsampleParameter::clear_has_width_scale() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void UpsampleParameter::clear_width_scale() {
  width_scale_ = 2;
  clear_has_width_scale();
}
inline ::google::protobuf::int32 UpsampleParameter::width_scale() const {
  // @@protoc_insertion_point(field_get:caffe.UpsampleParameter.width_scale)
  return width_scale_;
}
inline void UpsampleParameter::set_width_scale(::google::protobuf::int32 value) {
  set_has_width_scale();
  width_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.UpsampleParameter.width_scale)
}

// optional .caffe.UpsampleParameter.UpsampleOp mode = 5 [default = BILINEAR];
inline bool UpsampleParameter::has_mode() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void UpsampleParameter::set_has_mode() {
  _has_bits_[0] |= 0x00000010u;
}
inline void UpsampleParameter::clear_has_mode() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void UpsampleParameter::clear_mode() {
  mode_ = 1;
  clear_has_mode();
}
inline ::caffe::UpsampleParameter_UpsampleOp UpsampleParameter::mode() const {
  // @@protoc_insertion_point(field_get:caffe.UpsampleParameter.mode)
  return static_cast< ::caffe::UpsampleParameter_UpsampleOp >(mode_);
}
inline void UpsampleParameter::set_mode(::caffe::UpsampleParameter_UpsampleOp value) {
  assert(::caffe::UpsampleParameter_UpsampleOp_IsValid(value));
  set_has_mode();
  mode_ = value;
  // @@protoc_insertion_point(field_set:caffe.UpsampleParameter.mode)
}
...
template <> struct is_proto_enum< ::caffe::UpsampleParameter_UpsampleOp> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::UpsampleParameter_UpsampleOp>() {
  return ::caffe::UpsampleParameter_UpsampleOp_descriptor();
}
